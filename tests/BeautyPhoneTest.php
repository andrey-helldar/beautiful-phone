...
//        $this->assertEquals('<a href="tel:+73216665557"><span>+7 (321)</span> 666-555-7</a>', phone('+83216665557'));
    ...
    public function testWithEnabledHtmlAndDisabledLinkWithAttributes()
    {
        ...
        $this->assertEquals('<span>+7 (812)</span> 123-123', phone('123123', 0, true, false, $this->attributes));
        $this->assertEquals('<span>+3 (123)</span> 456-789-0', phone('31234567890', 0, true, false, $this->attributes));
        $this->assertEquals('<span>+3 (321)</span> 654-98-83', phone('+33216549883', 0, true, false, $this->attributes));
        $this->assertEquals('<span>+3 (321)</span> 666-555-7', phone('+33216665557', 0, true, false, $this->attributes));
        $this->assertEquals('<span>+7 (321)</span> 666-555-7', phone('+73216665557', 0, true, false, $this->attributes));
        $this->assertEquals('<span>+7 (321)</span> 666-555-7', phone('+83216665557', 0, true, false, $this->attributes));
    }
    ...
    public function testWithEnabledHtmlAndEnabledLinkWithAttributes()
    {
        ...
        $this->assertEquals('+7 (812) 123-123', phone('123123', 0, false, false, $this->attributes));
        $this->assertEquals('+3 (123) 456-789-0', phone('31234567890', 0, false, false, $this->attributes));
        $this->assertEquals('+3 (321) 654-98-83', phone('+33216549883', 0, false, false, $this->attributes));
        $this->assertEquals('+3 (321) 666-555-7', phone('+33216665557', 0, false, false, $this->attributes));
